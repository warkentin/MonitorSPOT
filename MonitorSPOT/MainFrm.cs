...
namespace MonitorSPOT
{
    public partial class MainFrm : Form
    {
            ...
            try            
            {
                foreach (var item in werke)
                {
                    ...
                    this.Invoke((MethodInvoker)delegate
                    {
                        ...
                        if (labelo.Length > 0) label = (Label)labelo[0];
                        //double l_mo = Convert.ToDouble(data[1].ToString());
        ...
        private void MainFrm_Paint(object sender, PaintEventArgs e)
        {
            ...
            e.Graphics.DrawLine(pen, 10, 90, 1045, 90);
            e.Graphics.DrawLine(pen, 10, 450, 1045, 450);
            e.Graphics.DrawLine(pen, 67, 45, 67, 450);
            e.Graphics.DrawLine(pen, 215, 45, 215, 450);
            e.Graphics.DrawLine(pen, 325, 45, 325, 450);
            e.Graphics.DrawLine(pen, 434, 45, 434, 450);
            e.Graphics.DrawLine(pen, 578, 45, 578, 450);
            e.Graphics.DrawLine(pen, 697, 45, 697, 450);
            e.Graphics.DrawLine(pen, 1000, 45, 1000, 450);
        }
        ...
        {
            ManagFrm frm = new ManagFrm();
            frm.g_servername = lbl_server_7000.Text;
            frm.g_Werksnummer = lbl_7000.Text.ToString();
            frm.ShowDialog();
        }
        ...
        private void Lbl_server_8200_Click(object sender, EventArgs e)
        {
            ManagFrm frm = new ManagFrm();
